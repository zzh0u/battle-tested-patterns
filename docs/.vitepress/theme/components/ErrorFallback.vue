...
<template>
  ...
  <div v-if="!isViz" class="error-boundary" role="alert" aria-atomic="true">
    ...
    <div class="error-boundary-actions">
      ...
      <a class="error-boundary-btn error-boundary-btn--outline" :href="issueUrl" target="_blank" rel="noopener noreferrer">
  ...
  <div v-else class="viz-container viz-error-boundary" role="alert" aria-atomic="true">
    ...
    <div class="viz-error-actions">
      ...
      <a class="viz-btn viz-btn--outline" :href="issueUrl" target="_blank" rel="noopener noreferrer">
        {{ isZh ? '反馈问题' : 'Report Issue' }}
      </a>
